...
public class Authenticationhandler implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext) {
        ...
        if(requestContext.getUriInfo().getPath().equals("/v1/auth")||requestContext.getUriInfo().getPath().equals("/card/v1/transaction/update")||requestContext.getUriInfo().getPath().startsWith("/card/v1/refund")){
